...
If you like the trio (`R` + `Hugo` + `Netlify`), you can read more on Hugo's configuration <a href="https://gohugo.io/getting-started/configuration/" target="_blank">here</a>.
